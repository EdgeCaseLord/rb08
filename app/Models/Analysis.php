            ...
            if (!empty($analysis->approval_by)) {
                ...
                if (!$doctor) {
                    $doctor = User::create([
                        ...
                        'email' => strtolower(str_replace('dr', '.', $analysis->approval_by)) . '@myintest-rezepte.de',
                        'password' => null,
                        'role' => 'doctor',
            ...
            if ($analysis->patient_code) {
                ...
                if (!$patient) {
                    $patient = User::create([
                        ...
                        'email' => strtolower(str_replace(' ', '.', $analysis->patient_name ?? 'unknown')) . '.' . ($analysis->patient_code ?? 'unknown') . '@myintest-rezepte.de',
                        'password' => null,
                        'role' => 'patient',
